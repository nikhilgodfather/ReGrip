...
const PdfWithImages = ({
            ...
            <View style={styles.page}>
              <View style={styles.table}>
                <View style={styles.row}>
                  ...
                  <Text style={[styles.cell, styles.header]}>Image</Text>
                </View>
                {excelData.map((data, index) => (
                  <View style={styles.row} key={index}>
                    ...
                    <Image
                      ...
                      source={data.tyre_serial_number_image_url_64}
                    />
                    <Text style={styles.cell} break>
                      {data.tyre_size}
                    </Text>
                    ...
                    <Image
                      style={styles.imageCell}
                      source={
                        data.crown_area_defect === "ok"
                          ? require("../../../assets/Placeholder_view_vector.png")
                          : { uri: `${data.crown_area_image_64}` }
                      }
                    />
                    <Text style={styles.cell} break>
                    ...
                    <Image
                      style={styles.imageCell}
                      source={
                        data.sidewall_area_defect === "ok"
                          ? require("../../../assets/Placeholder_view_vector.png")
                          : { uri: `${data.sidewall_area_image_64}` }
                      }
                    />
                    <Text style={styles.cell} break>
                    ...
                    <Image
                      style={styles.imageCell}
                      source={
                        data.inner_crown_defect === "ok"
                          ? require("../../../assets/Placeholder_view_vector.png")
                          : { uri: `${data.inner_crown_image_64}` }
                      }
                    />
                    <Text style={styles.cell} break>
                      {data.bead_defect}
  ...
  return (
    <PDFDownloadLink document={generatePDF(excelData)} fileName={`${fileName}`}>
      {({ loading, blob, url }) => (
