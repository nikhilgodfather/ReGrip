...
const Pending = ({ allLeave, loading, getAllLeave }) => {
        ...
        <div className='all-leave'>
            ...
            >
                ...
                >
                    ...
                    <LeaveRequestModal setUpdateStatusShow={setUpdateStatusShow} getAllLeave={getAllLeave} leave_id={leave_id} />
                </Sheet>
            </Modal>
            <div className="leave-status-table-container">
                    ...
                    <tbody style={{ width: '100%' }}>
                        {
                            loading === true ?
                                ...
                                :
                                allLeave
                                    ?.filter(leaves => leaves?.status === 'pending')
                                    ?.map((leaves, i) => {
                                        const {
                                            applied_by_name,
                                            start_date,
                ...
                {
                    allLeave?.filter(leaves => leaves?.status === 'pending')?.length === 0 && !loading &&
