...
const RejectedLeave = ({ allLeave, loading }) => {
    ...
    return (
        <div className='all-leave'>
            ...
            <div className="leave-status-table-container">
                    ...
                    <tbody style={{ width: '100%' }}>
                        {
                            loading === true ?
                                ...
                                :
                                allLeave
                                    ?.filter(leaves => leaves?.status === 'rejected')
                                    ?.map((leaves, i) => {
                                        const {
                                            applied_by_name,
                                            start_date,
                ...
                {
                    allLeave?.filter(leaves => leaves?.status === 'rejected')?.length === 0 && !loading &&
